...
(function($) {
	...
	$('#clock').countdown('2022/01/10 23:59:59') /* change here your "countdown to" date */
	.on('update.countdown', function(event) {
		var format = '<span class="counter-number">%D<br><span class="timer-text">Дней</span></span><span class="counter-number">%H<br><span class="timer-text">Часов</span></span><span class="counter-number">%M<br><span class="timer-text">Минут</span></span><span class="counter-number">%S<br><span class="timer-text">Секунд</span></span>';
		$(this).html(event.strftime(format));
	})
	.on('finish.countdown', function(event) {
	$(this).html('Данное событие уже закончилось!')
